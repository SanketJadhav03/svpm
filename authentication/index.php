    ...
    <style>
        body {
            ...
            background:
                ...
                url("Collegeimage.jpg") center/cover no-repeat fixed;
        ...
        .btn {
            ...
            background: linear-gradient(145deg, #0074d9, #005bb5);
            /* Button gradient */
            border: none;
            border-radius: 10px;
            color: white;
