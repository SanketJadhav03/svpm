    ...
    if (isset($_POST['latitude']) && isset($_POST['longitude'])) {
        ...
        if (!empty($_FILES['photoData']['tmp_name'])) {
            ...
            if (move_uploaded_file($_FILES['photoData']['tmp_name'], $imagePath)) {
                $stmt = $conn->prepare("INSERT INTO tbl_attendance (attendance_student_id, attendance_photo, attendance_latitude, attendance_longitude, attendance_date) VALUES (?, ?, ?, ?, NOW())");
